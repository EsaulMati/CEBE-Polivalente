  ...
  return (
    <div className="flex flex-col">
      ...
      <ConfirmationModal
        ...
        message={
          deleteTarget
            ? `¿Estás seguro de eliminar "${deleteTarget.Item}" (${deleteTarget.Producto})? Esta acción no se puede deshacer.`
            : ""
        }
            ...
            <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-800 text-left">
              <thead className="bg-slate-50 dark:bg-slate-800/70">
                <tr>
                  <th
                    scope="col"
                    className="px-6 py-3.5 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400"
                  >
                    Item / Código
                  </th>
                  <th
                  ...
                  <th
                    scope="col"
                    className="px-6 py-3.5 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 text-center"
                  >
                    Acciones
                  </th>
                </tr>
                ...
                {currentItems.length === 0 ? (
                    ...
                    <td colSpan="10" className="px-6 py-16 text-center">
                      ...
                      <div className="flex flex-col items-center gap-3">
                        ...
                        <p className="text-sm font-semibold text-slate-400 dark:text-slate-500">
                          No se encontraron activos que coincidan con la
                          búsqueda.
                        </p>
                  ...
                  currentItems.map((item, index) => (
                    ...
                    >
                      ...
                      <td
                        className="px-6 py-4 text-sm text-slate-500 dark:text-slate-400 font-medium max-w-xs truncate"
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-xs">
                        <span
                          className={`px-2.5 py-1 rounded-full border font-bold ${getEstadoBadgeClass(item.Estado)}`}
                        >
                          {item.Estado}
                        </span>
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-xs">
                        <span
                          className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full border font-bold ${getInventariadoBadgeClass(item.Inventariado)}`}
                        >
